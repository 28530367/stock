...
class MailHandler:
    ...
    def __init__(self):
        gmail_acct = "/home/shouweihuang/Lab_Training/stock/support_resistant-master/stock_project/common/gmail.json"
    ...
    def send(self, to_address, file, symbol):
        mail = self._create_mail(f"{symbol} Monitor Report {self._local_time}", to_address)
