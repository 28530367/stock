...
class Find_Technical_Analysis_Signals(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        # gap
        up_gap_interval = request.data.get("params")["gap"]["up_gap_interval"]
        down_gap_interval = request.data.get("params")["gap"]["down_gap_interval"]

        # volume
        previous_day = request.data.get("params")["volume"]["previous_day"]
        survival_time = request.data.get("params")["volume"]["survival_time"]

        # support resistant
        closeness_threshold = request.data.get("params")["sup_res"]["diff"]
        peak_left = request.data.get("params")["sup_res"]["peak_left"]
        peak_right = request.data.get("params")["sup_res"]["peak_right"]
        valley_left = request.data.get("params")["sup_res"]["valley_left"]
        valley_right = request.data.get("params")["sup_res"]["valley_right"]
        swap_times = request.data.get("params")["sup_res"]["swap_times"]

        # neckline
        nk_valley_left = request.data.get("params")["neckline"]["nk_valley_left"]
        nk_valley_right = request.data.get("params")["neckline"]["nk_valley_right"]
        nk_peak_left = request.data.get("params")["neckline"]["nk_peak_left"]
        nk_peak_right = request.data.get("params")["neckline"]["nk_peak_right"]
        nk_startdate = request.data.get("params")["neckline"]["nk_startdate"]
        nk_enddate = request.data.get("params")["neckline"]["nk_enddate"]
        nk_interval = request.data.get("params")["neckline"]["nk_interval"]
        nk_value = request.data.get("params")["neckline"]["nk_value"]
