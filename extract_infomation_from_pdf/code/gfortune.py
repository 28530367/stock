...
class Gfortune(ExtractPdf):
    '''Handle 福邦(Gfortune) pdf
    ...
    def get_all(self):
        ...
        stock = 'NULL'
        date = 'NULL'
        tp_1, tp_2, tp = 'NULL', 'NULL', 'NULL'
        author_1, author_2, author = 'NULL', 'NULL', 'NULL'
        summary_1, summary_2, summary = 'NULL', 'NULL', 'NULL'
    ...
    def check_source(self, text_check_source):
        check_source = ['Grand Fortune Securities']
    ...
    def get_rating_report_version_1(self, page):
        clip_report_version_1= fitz.Rect(0, 0, 190, 300)
        text_report_version_1 = page.get_text(clip=clip_report_version_1, sort=True).strip()
        try:
    ...
    def get_rating_report_version_2(self, page):
        clip_report_version_2 = fitz.Rect(30, 220, 190, 250)
